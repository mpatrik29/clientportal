...
type InputGroupProps = {
  ...
  disabled?: boolean;
  active?: boolean;
  onChange?: (e: React.ChangeEvent<HTMLInputElement>) => void; // Renamed from handleChange to onChange
  value?: string;
  name?: string;
    ...
    <div className={className}>
      ...
      >
        <input
          ...
          onChange={onChange} // Updated to use onChange
          value={props.value}
